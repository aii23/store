...
export default function NFTStorefront({
  ...
  const [choosenNFTID, setChoosenNFTID] = useState<string | undefined>(
    undefined
  );
  return (
    <section
    ...
    >
      ...
      >
        {gridMode == 1 && (
          <div
            className={
              "grid grid-cols-10 border-b border-[#373737] py-[0.521vw]"
            }
          >
            <span
              className={
            ...
            <span
              className={
                "col-span-2 font-plexsans leading-[110%] text-[0.833vw] text-foreground"
              }
            >
              Price
            </span>
