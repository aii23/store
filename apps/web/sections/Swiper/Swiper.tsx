...
const Slide = ({ slide }: { slide: ISlideData }) => {
  if (slide.link)
    return (
      <Link
        href={slide.link}
      ...
      >
        <div className="flex h-full w-full items-center justify-center">
          <Image
            width={1600}
            height={1000}
            src={`https://res.cloudinary.com/dw4kivbv0/image/upload/w_2400,f_auto,fl_progressive:semi,q_auto:best/v1738156358/${slide.image.provider_metadata.public_id}`}
            alt="Slide"
            className="w-full"
          />
        </div>
