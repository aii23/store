...
const AccountPopupBalance = dynamic(() => import('./nonSSR/AccountPopupBalance'), {
  ssr: false,
});
    ...
    >
      <div className={'flex w-full flex-row justify-between'}>
        <div className={'flex w-full flex-row items-center gap-2'}>
          ...
          <span className={'font-museo text-headline-3 text-bg-dark'}>Account</span>
        </div>
        <svg
          width="24"
          height="25"
      ...
      {avatarMode ? (
        <div className={'mt-8 flex h-full w-full flex-col'}>
          <div className={'flex w-full flex-row items-center justify-between'}>
            <div className={'font-museo text-[0.833vw] font-medium text-bg-dark'}>Avatars</div>
            <button
              className={
            ...
            >
              ...
              >
                <path d="M8.36328 0.5L1.10522 8L8.36328 15.5" stroke="#212121" />
              </svg>
              <span className={'pt-px font-museo text-[0.729vw] font-medium text-bg-dark'}>
                Back
              </span>
            </button>
          </div>
        ...
        <div className={'mt-8 flex w-full flex-col gap-4'}>
          ...
          <div className={'flex w-full flex-row gap-1.5'}>
            ...
            >
              ...
              <span className={'font-museo text-[16px]/[16px] font-medium'}>Disconnect Wallet</span>
            </button>
          </div>
        </div>
      )}
